这回来整理一下这题逆向。我是个学艺不精的默默无闻的对二进制了解不多的普通学生，做这个还是有点难度的，还好队里的大佬给稍微指点了一下，感谢大佬[@Apeng](https://apeng.fun/)。下面大概是我的解题过程，如果有问题或是错误，还望各位大佬指点。
...
综上，随意构造前三个和后三个数字相等且不全为0的六个数字即可，例如：
